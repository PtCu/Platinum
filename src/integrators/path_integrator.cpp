...
namespace platinum
{
	PLT_REGISTER_CLASS(PathIntegrator, "Path")

	PathIntegrator::PathIntegrator(const PropertyTreeNode &node)
		: SamplerIntegrator(nullptr, nullptr), m_maxDepth(node.getPropertyList().getInteger("Depth", 2)), m_rrThreshold(1.f), m_lightSampleStrategy("spatial")
	{
		//Sampler
