...
void createWorld(Scene& world)
{
    ...
    auto floor = make_shared<TriMesh>("../../../../../assets/models/cornellbox/floor.obj", grayMat);
    auto shortbox = make_shared<TriMesh>("../../../../../assets/models/cornellbox/shortbox.obj", cubeMat);
    auto tallbox = make_shared<TriMesh>("../../../../../assets/models/cornellbox/tallbox.obj", cubeMat);
    auto left = make_shared<TriMesh>("../../../../../assets/models/cornellbox/left.obj", redMat);
    auto right = make_shared<TriMesh>("../../../../../assets/models/cornellbox/right.obj", greenMat);
    auto light_ = make_shared<TriMesh>("../../../../../assets/models/cornellbox/light.obj", lightMat);
